...
BOOST_TARBALL="$HOME/deps_src/boost_$BOOST_VERSION2.tar.bz2"
BOOST_SRC="$HOME/deps_src/boost_${BOOST_VERSION2}"
OUTPUT_DIR="$BOOST_SRC/build/boost/$BOOST_VERSION"
